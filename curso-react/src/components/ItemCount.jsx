    ...
    return (
        <div className="container">
            ...
            <div className="row my-1">
                <div className="col">
                    {visible ? <button type="button" className="btn bg-black text-white text-uppercase rounded-0" onClick={addToCart}>Agregar Producto al Carrito</button> : <Link to={"/Cart"} className="btn bg-black text-white text-uppercase rounded-0">Finalizar Compra</Link>  }
                </div>
            </div>
        </div>
    )
